...
from operation import AddOperation, SubtractOperation, MultiplyOperation, DivideOperation
...
class TestCalculation:
    ...
    @pytest.mark.parametrize("a, b, operation_class, expected", [
    ...
    @pytest.mark.parametrize("operation_class, expected_symbol", [
        (AddOperation, '+'),
        (SubtractOperation, '-'),
        (MultiplyOperation, '*'),
        (DivideOperation, '/')
...
class TestCalculationFactory:
    ...
    @pytest.mark.parametrize("operation_type, a, b, expected_result", [
        ("add", 5, 3, 8),
        ("subtract", 10, 4, 6),
        ("multiply", 3, 7, 21),
        ("divide", 12, 3, 4.0),
    ...
    def test_create_calculation_valid_operations(self, operation_type, a, b, expected_result):
    ...
    @pytest.mark.parametrize("operation_type", [
        "ADD", "SUBTRACT", "MULTIPLY", "DIVIDE",  # uppercase
        " add ", " + ",  # with whitespace
        "Add", "Subtract"  # mixed case
    ])
